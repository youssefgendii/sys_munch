const menuData = {
    sandwiches: [
        ...
        { id: 4, name: 'Dynamite Chicken Pops', price: 160, icon: '☕🍽️', nameAr: 'بوبس دجاج ديناميت', quantity: 35 },
    ...
    snacks: [
        ...
        { id: 14, name: 'Dynamite Shrimp Pops', price: 275, icon: '☕🍽️', nameAr: 'بوبس جمبري ديناميت', quantity: 25 },
